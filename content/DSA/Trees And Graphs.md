...
![Trie](Trie.png "Trie Data Structure Example")
...
1. `getSum(x)` - Returns the sum of the subarray `arr[0 ... x]`
    ...
    - Return `sum`
![Fenwick getSum()](FenwickGetSum.png "Fenwick getSum()")
2. `update(x, val)` - Update the Binary Indexed Tree by performing `arr[index] += val`, it will make changes to `BITree[]`
    ...
    - Do the following while the current index is smaller than or equal to `n`
        ...
        - Go to the next element of `BITree[index]`
            ...
            - `index = index + (index & (-index))`
![Fenwick update()](FenwickUpdate.png "Fenwick update()")
...
![Directed and Undirected](DirectedAndUndirectedGraph.png "Directed and Undirected")
...
![Weighted](WeightedGraph.png "Weighted Graph")
...
![Rooted Trees](RootedTrees.png "Rooted Trees")
...
![Connected and Disconneted](ConnectedAndDisconnectedGraph.png "Connected and Disconnected")
...
![Cyclic Acyclic](CyclicAndAcyclicGraph.png "Cyclic Acyclic")
...
![Bipartite](BipartiteGraph.png "Bipartite")
...
![SCCs](StronglyConnectedComponents.png "SCCs")
